# Modelo 025 — D_014_2025 - CLUBE DE CAMPO.xlsx
...
- Arquivo original: `D_014_2025 - CLUBE DE CAMPO.xlsx`
- Família provisória: **Dragagem/bombeamento**
- SHA-256 do arquivo: `27e58c2fa719138474a3a0605de3cb952e92161d1f552436a499b1073bc8fa54`
- Abas analisadas: **9**
- Fórmulas encontradas: **195**
...
| 4 | `2. Canteiro` | `A1:F28` | 18 | canteiro |
| 5 | `3. Prep. Área - Ensecadeira` | `A1:L22` | 21 | outros |
| 6 | `6. Medição` | `A1:G24` | 3 | medicao_batimetria |
| 7 | `7. Dragagem` | `A1:L250` | 85 | dragagem_operacao |
| 8 | `8. Desmob. Draga` | `A1:G21` | 18 | mobilizacao_draga, desmobilizacao |
| 9 | `Plan. Preços` | `A1:M10` | 19 | formacao_preco |
...
- Dados da obra
- Objeto
- Desassoreamento lago com bombeamento direto
- Local
- CLUBE DE CAMPO SAO PAULO
- Volume dragagem (m³)
- Tipo de material
- Areia + Argila
...
- Altura da Leira
- m
- Preciso de uma área de 100 x 50
- ou seja
- Item
- Descrição dos serviços
- Unid.
...
- Preço Unit.
- Preço Total
- Volume possivel em area a ser criada
...
| `I5` | `=((H5/100)+1)*G5` |
| `J5` | `=E5*I5` |
| `C6` | `='3. Prep. Área - Ensecadeira'!F22` |
| `E6` | `='3. Prep. Área - Ensecadeira'!L12` |
| `G6` | `=C6/E6` |
| `I6` | `=((H6/100)+1)*G6` |
| `J6` | `=E6*I6` |
| `C7` | `='7. Dragagem'!D247` |
