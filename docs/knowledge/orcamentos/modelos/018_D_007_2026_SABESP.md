# Modelo 018 — D_007_2026 - SABESP.xlsx
...
- Arquivo original: `D_007_2026 - SABESP.xlsx`
- Família provisória: **Dragagem com bags/geotêxteis**
- SHA-256 do arquivo: `2f6a130a1f1bf66cee26ef706936e4048d1c6b2187dcd5528126d11517cff354`
- Abas analisadas: **17**
- Fórmulas encontradas: **380**
...
| 5 | `1. Mob. Draga` | `A1:O27` | 22 | mobilizacao_draga |
...
| 9 | `4. Forn. Bag` | `A1:K52` | 38 | bags_geotexteis |
...
| 16 | `10. Plan. Preços` | `A1:M18` | 32 | formacao_preco |
| 17 | `Planilha1` | `A1:I12` | 11 | resumo_comercial |
...
| `I11` | `=SUM('8. Desmob. Draga'!F21+'9. Desmob. Eq. Polimero '!F26)` |
| `C12` | `=SUM(C5:C11)` |
| `J12` | `=SUM(J4:J11)` |
| `J18` | `=(SUM(J6:J9))/E8` |
...
- m2
- Fornecimento Geobags 8,00 m x 30,00 m
- un
- Fornecimento Geobags 8,00 m x 15,00 m
...
- m3 desaguado (volume dentro do bag)
...
| Célula | Fórmula |
|---|---|
| `F3` | `=SUM('10. Plan. Preços'!J4:J5)` |
| `G3` | `=E3*F3` |
| `E4` | `=2496*2` |
| `F4` | `=G4/E4` |
| `G4` | `=SUM('10. Plan. Preços'!J6)` |
| `G5` | `=E5*F5` |
| `G6` | `=E6*F6` |
| `G7` | `=E7*F7` |
| `F8` | `=SUM('8. Desmob. Draga'!F21+'9. Desmob. Eq. Polimero '!F26)` |
| `G8` | `=F8*E8` |
| `G9` | `=SUM(G3:G8)` |
