# Modelo 012 — composição SK - BH -  - apresentado.xlsx
...
- Arquivo original: `composição SK - BH -  - apresentado.xlsx`
- Família provisória: **Dragagem com centrífuga**
- SHA-256 do arquivo: `4911b1ddf6c14638c1d1b1010d2bdf8c75126d6828a19e3652c638e72597cac4`
- Abas analisadas: **13**
...
|---:|---|---|---:|---|
| 1 | `Dados Obra` | `A1:P43` | 21 | dados_obra |
| 2 | `Produção` | `A1:S23` | 28 | producao_prazo |
| 3 | `cronograma` | `A1:V10` | 1 | outros |
| 4 | `Canteiro` | `A1:N33` | 47 | canteiro |
| 5 | `1.1.Mob. MO` | `A1:M40` | 56 | outros |
| 6 | `1.2.Mob Centrífuga` | `A1:N39` | 86 | mobilizacao_sistema, operacao_desaguamento |
| 7 | `2.2 Centrífuga` | `A1:L205` | 100 | operacao_desaguamento |
| 8 | `2.3. manutenção` | `A1:L20` | 44 | outros |
| 9 | `DesMob. Draga` | `A1:M40` | 51 | mobilizacao_draga, desmobilizacao |
| 10 | `DesMob Centrífuga` | `A1:N39` | 75 | mobilizacao_sistema, operacao_desaguamento, desmobilizacao |
| 11 | `Plan. Final` | `A1:N24` | 47 | outros |
| 12 | `Final` | `A1:L9` | 12 | outros |
| 13 | `Planilha1` | `A1:B14` | 1 | resumo_comercial |
...
- Células numéricas observadas: **95**
...
- Fórmulas: **56**
- Conceitos provisórios: outros
- Células numéricas observadas: **104**
...
- Células numéricas observadas: **153**
...
- Base apoio Tq Equal.
- Plano de Rigger
- Carreta Carga Seca para CENTRÍFUGA (01 un)
...
- Já compramos uma vez ainda existe
...
| `I6` | `=((H6/100)+1)*G6` |
| `J6` | `=E6*I6` |
| `C9` | `='2.2 Centrífuga'!D199` |
| `E9` | `='Dados Obra '!B14` |
| `G9` | `=C9/E9` |
| `I9` | `=((H9/100)+1)*G9` |
| `J9` | `=E9*I9` |
| `L9` | `=J9+J10` |
| `M9` | `='Dados Obra '!L27+26` |
| `N9` | `=L9/M9` |
| `C10` | `='2.3. manutenção'!F16` |
| `F10` | `=F9` |
| `G10` | `=C10/E10` |
| `I10` | `=((H10/100)+1)*G10` |
| `J10` | `=E10*I10` |
| `C13` | `='DesMob. Draga '!F33` |
| `G13` | `=C13/E13` |
| `I13` | `=((H13/100)+1)*G13` |
| `J13` | `=E13*I13` |
| `L13` | `=J13+J14` |
| `C14` | `='DesMob Centrífuga'!F28` |
| `G14` | `=C14/E14` |
| `I14` | `=((H14/100)+1)*G14` |
| `J14` | `=E14*I14` |
| `C16` | `=SUM(C4:C15)` |
...
- Mobilização da Planta de Desidratação
- vb
- Desidratação de lodo através do processo de Centrifugação
- tonelada desaguada (peso material em caçambas)
- #REF!
- BDI 50%
...
| `D4` | `='Dados Obra '!L27+26` |
| `E4` | `='Plan. Final'!N9` |
| `F4` | `=F9` |
| `I4` | `='Plan. Final'!#REF!` |
| `E5` | `=I5` |
| `F5` | `=D5*E5` |
| `I5` | `='Plan. Final'!J13+'Plan. Final'!J14` |
| `F6` | `=SUM(F3:F5)` |
| `F9` | `=D9*E9` |
