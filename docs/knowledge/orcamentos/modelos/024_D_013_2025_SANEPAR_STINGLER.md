# Modelo 024 — D_013_2025- Sanepar - Stingler.xlsx
...
- SHA-256 do arquivo: `2d96e806fc1f873a26714fd03f20870242dc782c54157cc32a56a44097a8f876`
- Abas analisadas: **15**
- Fórmulas encontradas: **337**
...
| 7 | `3. Prep. Célula` | `A1:P29` | 33 | estrutura_desaguamento |
| 8 | `4. Forn. Bag` | `A1:G34` | 27 | bags_geotexteis |
| 9 | `5. Canteiro de obras` | `A1:F31` | 24 | canteiro |
| 10 | `6. Operação Sistema` | `A1:G24` | 20 | operacao_desaguamento |
...
| 15 | `11. Plan. Preços` | `A1:M17` | 25 | formacao_preco |
...
- Dados da obra
- Objeto
- Dragagem e Desaguamento Lagoa Stingler
- Local
- Lapa - PR
- Volume dragagem (m³)
- Tipo de material
...
- Células numéricas observadas: **4**
...
- kg
- Total ton secas (4 kg por ton seca) - Estamos pagando 17 reias no kg do polimero em Curitiba
- Frete Polimero
- un
- 1500 em cada
- (REUSO) fornecimento de água para operação (bomba de captaçao + Painel)
