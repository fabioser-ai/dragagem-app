# Modelo 040 — D_061_2025 - Bracell - Bags em 2 níveis - SEM polímero.xlsx
...
- Arquivo original: `D_061_2025 - Bracell - Bags em 2 níveis - SEM polímero.xlsx`
- Família provisória: **Dragagem com bags/geotêxteis**
- SHA-256 do arquivo: `e33e9b828c5a119bc9a9d835d12c3f78c9ff051e23dca96251b742a1b1d92103`
- Abas analisadas: **14**
- Fórmulas encontradas: **588**
...
|---:|---|---|---:|---|
| 1 | `Dados Obra` | `A1:P27` | 12 | dados_obra |
| 2 | `Resumo Técnico` | `A1:B12` | 1 | resumo_comercial |
| 3 | `Produção` | `A1:I39` | 13 | producao_prazo |
| 4 | `1.1. Canteiro` | `A1:P33` | 42 | canteiro |
| 5 | `1.2. Mob Draga + Pol.` | `A1:M51` | 68 | mobilizacao_draga |
| 6 | `1.2.1.Barrilete` | `A1:F31` | 39 | barrilete_linha |
| 7 | `2. Prep Célula` | `A1:O37` | 65 | estrutura_desaguamento |
| 8 | `3.1. Bags` | `A1:M50` | 60 | bags_geotexteis |
| 9 | `3.2 Draga` | `A1:N207` | 92 | outros |
| 10 | `3.3 Op.Planta` | `A1:M37` | 41 | outros |
| 11 | `3.4.Medição` | `A1:K28` | 29 | medicao_batimetria |
| 12 | `DesMob Draga + Pol.` | `A1:M51` | 67 | mobilizacao_draga, desmobilizacao |
| 13 | `Plan. BDI` | `A1:M22` | 38 | formacao_preco |
| 14 | `Plan. Final.` | `A1:H7` | 21 | outros |
...
- Operadores de Draga com larga experiência em dragagem de lagoas de fábricas de papel e celulose
...
- Geobags de polipropileno de alta resistência - adquiridos junto a empresa multinacional com produtos reconhecidos mundialmente pela qualidade, resistência e eficiência em cada uma de suas aplicações
- Ficha Técnica dos Geobags garantindo procedência, qualidade, resistência e eficiência do produto a ser empregado
...
- Células numéricas observadas: **147**
...
- Fórmulas: **41**
- Conceitos provisórios: outros
- Células numéricas observadas: **84**
...
- Células numéricas observadas: **110**
