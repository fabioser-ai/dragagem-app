# Modelo 009 — Composição preços - Draga 14 SBV - sem equipe.xlsx
...
- Arquivo original: `Composição preços - Draga 14 SBV - sem equipe.xlsx`
- Família provisória: **Composição padrão de draga**
- SHA-256 do arquivo: `f5c5b5ba512b054dda13cff8558796fbe26a73215ff3d3f3bb3ab1cc70f1c3eb`
- Abas analisadas: **6**
- Fórmulas encontradas: **223**
...
| 3 | `1. Mobilização` | `A1:N39` | 52 | outros |
| 4 | `2. Dragagem` | `A1:L253` | 86 | dragagem_operacao |
| 5 | `3. Desmobilização` | `A1:N39` | 51 | desmobilizacao |
| 6 | `FINAL` | `A1:K11` | 22 | outros |
...
- h/dia
- Dias de Trabalho (2ª a sexta ADM)
- dias/mês
...
| `L20` | `=J20*K20` |
| `A21` | `=L24` |
| `D21` | `='1. Mobilização'!N6` |
| `L21` | `=J21*K21` |
| `A22` | `=L24` |
| `D22` | `='1. Mobilização'!N8` |
| `A23` | `=L24` |
| `D23` | `='1. Mobilização'!N10` |
| `L23` | `=J23*K23` |
| `A24` | `=L24` |
| `D24` | `='1. Mobilização'!C8` |
| `L24` | `=(L20*1.7)+(L21*2)+L23` |
| `A25` | `=L24` |
| `D25` | `='1. Mobilização'!C11` |
| `A26` | `=L24` |
...
- Células numéricas observadas: **134**
...
| `I5` | `=((H5/100)+1)*G5` |
| `J5` | `=E5*I5` |
| `K5` | `=J5/ROUNDUP(Produção!D24,0)` |
| `C6` | `='3. Desmobilização'!F32` |
| `G6` | `=C6/E6` |
| `I6` | `=((H6/100)+1)*G6` |
| `J6` | `=E6*I6` |
| `C7` | `=SUM(C4:C6)` |
