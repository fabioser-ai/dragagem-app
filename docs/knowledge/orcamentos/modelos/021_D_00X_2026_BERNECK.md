# Modelo 021 — D_00X_2026 - BERNECK.xlsx
...
- Arquivo original: `D_00X_2026 - BERNECK.xlsx`
- Família provisória: **Dragagem com bags/geotêxteis**
- SHA-256 do arquivo: `130a7b8d8a27058be15cb6cf56fb34f7609016a9fa45867679b24fc073847ab6`
- Abas analisadas: **13**
- Fórmulas encontradas: **579**
...
| 2 | `Produção` | `A1:I39` | 14 | producao_prazo |
| 3 | `1.1. Canteiro` | `A1:P33` | 42 | canteiro |
| 4 | `1.2. Mob Draga + Pol.` | `A1:M51` | 68 | mobilizacao_draga |
| 5 | `1.2.1.Barrilete` | `A1:F31` | 39 | barrilete_linha |
| 6 | `2. Prep Célula` | `A1:U42` | 63 | estrutura_desaguamento |
| 7 | `3.1. Bags` | `A1:M50` | 60 | bags_geotexteis |
| 8 | `3.2 Draga` | `A1:N207` | 94 | outros |
| 9 | `3.3 Op.Planta` | `A1:M37` | 42 | outros |
...
- Dados da obra
- Objeto
- DRAGAGEM LAGOAS 02 e 04 com desaguamento e destinaçao
- Local
- CURITIBANOS - SC
- Volume dragagem (m³)
- Tipo de material
- LAGOAS NATURAIS + POUCO EFLUENTE
