# Modelo 020 — D_009_2025- HOLAMBRA - ETE.xlsx
...
- Arquivo original: `D_009_2025- HOLAMBRA - ETE.xlsx`
- Família provisória: **Dragagem com bags/geotêxteis**
- SHA-256 do arquivo: `392864f78a4a98b35914d19191518d15a9b03fba375d9acdffcd94497d0711a9`
- Abas analisadas: **16**
- Fórmulas encontradas: **346**
...
| 7 | `3. Prep. Célula` | `A1:P29` | 29 | estrutura_desaguamento |
| 8 | `4. Forn. Bag` | `A1:G34` | 27 | bags_geotexteis |
| 9 | `5. Canteiro de obras` | `A1:F31` | 23 | canteiro |
| 10 | `6. Operação Sistema` | `A1:G24` | 19 | operacao_desaguamento |
...
| 15 | `11. Transferencia` | `A1:F21` | 16 | outros |
| 16 | `12. Plan. Preços` | `A1:L13` | 24 | formacao_preco |
...
- Dados da obra
- Objeto
- Dragagem duas Lagoas ETE Cachoeira
- Local
- HOLAMBRA - SP
- Volume dragagem (m³)
- Tipo de material
