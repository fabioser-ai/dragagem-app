# Modelo 010 — Composição preços - Draga 14 SBV.xlsx
...
- Arquivo original: `Composição preços - Draga 14 SBV.xlsx`
- Família provisória: **Composição padrão de draga**
- SHA-256 do arquivo: `5059e3833a5218e4f8e2d2aa26a8125fcaa8d3b12524bae82ab2444fed1ad512`
- Abas analisadas: **5**
- Fórmulas encontradas: **200**
...
| 3 | `1. Mobilização` | `A1:N39` | 53 | outros |
| 4 | `2. Dragagem` | `A1:L249` | 83 | dragagem_operacao |
