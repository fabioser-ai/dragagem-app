# Modelo 029 — D_036_2025_A - SAEC - Catanduva- SP.xlsx
...
- Arquivo original: `D_036_2025_A - SAEC - Catanduva- SP.xlsx`
- Família provisória: **Dragagem com bags/geotêxteis**
- SHA-256 do arquivo: `614f4ef08cd11aa3f322eccc14f488bf4ebb6dda29dce966cc98b5f51b26d6f9`
- Abas analisadas: **16**
- Fórmulas encontradas: **382**
...
| 8 | `3. Prep. Célula` | `A1:P30` | 35 | estrutura_desaguamento |
| 9 | `4. Forn. Bag` | `A1:P56` | 42 | bags_geotexteis |
| 10 | `5. Operação Sistema` | `A1:H27` | 19 | operacao_desaguamento |
| 11 | `7. Dragagem` | `A1:L253` | 78 | dragagem_operacao |
| 12 | `8. Medição` | `A1:F23` | 20 | medicao_batimetria |
| 13 | `9. Transferencia` | `A1:F22` | 17 | outros |
| 14 | `10. Desmob. Draga` | `A1:F21` | 20 | mobilizacao_draga, desmobilizacao |
| 15 | `11. Desmob. Eq. Polimero` | `A1:F26` | 16 | mobilizacao_sistema, desmobilizacao |
| 16 | `10. Plan. Preços` | `A1:O15` | 38 | formacao_preco |
...
- Células numéricas observadas: **120**
...
- Células numéricas observadas: **73**
...
| `I10` | `=((H10/100)+1)*G10` |
| `J10` | `=E10*I10` |
| `C11` | `='10. Desmob. Draga'!F21` |
| `G11` | `=C11/E11` |
| `I11` | `=((H11/100)+1)*G11` |
| `J11` | `=E11*I11` |
| `C12` | `='11. Desmob. Eq. Polimero '!F26` |
| `L12` | `=SUM(J12,J11)` |
| `C13` | `=SUM(C4:C12)` |
| `J13` | `=SUM(J4:J12)` |
| `M13` | `=J13/12600` |
