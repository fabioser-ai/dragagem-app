# Modelo 037 — D_059_2025 - Bracell - paliçada SEM polímero.xlsx
...
- Arquivo original: `D_059_2025 - Bracell - paliçada SEM polímero.xlsx`
- Família provisória: **Dragagem com paliçada/bacia**
- SHA-256 do arquivo: `efdc4845e078ca09f2b0ff9586715edd4e7cf66512af88724afd505862c961be`
- Abas analisadas: **16**
- Fórmulas encontradas: **590**
...
| 7 | `2.2. Mob. Eq. Polimero` | `A1:M26` | 34 | mobilizacao_sistema |
...
| 12 | `Op. Polimero` | `A1:M37` | 36 | outros |
| 13 | `4.4. Medição` | `A1:K28` | 37 | medicao_batimetria |
| 14 | `6.1 Desmob. Draga` | `A1:G35` | 41 | mobilizacao_draga, desmobilizacao |
...
- vb/mês
- Mobilização e Montagem dos Equipamentos de Dragagem
- vb
- Preparo das Bacias ecológicas para desidratação do lodo dragado, incluindo impermeabilização de base
- m²
- Dragagem de lodo das lagoas, incluindo controle do processo de desaguamento das bacias ecológicas
- m³
