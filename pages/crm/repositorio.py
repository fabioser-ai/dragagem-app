...
def garantir_estrutura_crm():
    DATA_DIR.mkdir(parents=True, exist_ok=True)

    arquivos = [
        (ARQUIVO_CLIENTES, COLUNAS_CLIENTES),
        (ARQUIVO_CONTATOS, COLUNAS_CONTATOS),
        (ARQUIVO_INTERACOES, COLUNAS_INTERACOES),
    ]
...
def atualizar_cliente_apos_interacao(dados_interacao: dict):
    ...
    clientes.loc[idx, "responsavel"] = dados_interacao.get("responsavel", clientes.loc[idx, "responsavel"])
