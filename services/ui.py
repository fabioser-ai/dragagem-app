...
def aplicar_estilo_global():
    ...
    :root {
        ...
        --fos-copper: #c45d35;
        --fos-copper-dark: #ab4527;
        --fos-copper-deep: #8f4229;
    }
    ...
    .stButton > button { background-color: var(--fos-copper) !important; color: #ffffff !important; border-radius: 10px !important; border: none !important; height: 42px; font-weight: 600 !important; }
    .stButton > button p, .stButton > button span, .stButton > button div { color: #ffffff !important; font-weight: 600 !important; }
    .stButton > button:hover { background-color: var(--fos-copper-dark) !important; color: #ffffff !important; }
    ...
    input:focus, textarea:focus { border-color: var(--fos-copper) !important; box-shadow: 0 0 0 2px rgba(196, 93, 53, 0.12) !important; }
    ...
    [data-baseweb="select"]:focus-within > div { border-color: var(--fos-copper) !important; }
    ...
    [data-testid="stDataFrame"] [role="columnheader"] { background-color: var(--fos-copper) !important; }
    ...
    table th { background-color: var(--fos-copper) !important; color: #ffffff !important; }
    ...
    button[data-baseweb="tab"][aria-selected="true"] { color: var(--fos-copper-dark) !important; border-bottom-color: var(--fos-copper) !important; }
    [data-testid="stCheckbox"] svg, [data-testid="stRadio"] svg { color: var(--fos-copper) !important; }
    a { color: var(--fos-copper-dark); }
